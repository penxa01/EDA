...
def backtracking(tabla:np.array,asignacion_actual:np.array,N:int,paso =0,mejor_asignacion = None):
...
if __name__ == '__main__':
    ...
    print('Tabla de trabajdores y tareas')
    ...
    print('El tiempo para esta asignacion es {}'.format(tiempo))